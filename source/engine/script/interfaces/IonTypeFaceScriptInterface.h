...
namespace ion::script::interfaces
{
	...
	///@brief A class representing an interface to a type face script with a complete validation scheme
	///@details A type face script can load type faces from a script file into a type face manager
	class TypeFaceScriptInterface final : public ScriptInterface
	{
		...
		public:
			...
			*/
			...
			///@brief Creates type faces from a script (or object file) with the given asset name
