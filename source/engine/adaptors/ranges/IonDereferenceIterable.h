...
{
	///@brief A class that provides functionality for a forward dereference iterable range
	...
	///@brief A class that provides functionality for an reverse dereference iterable range
	template <typename Container>
