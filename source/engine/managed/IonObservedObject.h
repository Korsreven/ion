...
namespace ion::managed
{
	...
	///@brief A class representing an observed (managed) object
	///@details An observed object can be optional or mandatory, meaning if it's removable or not.
		...
		protected events::EventChannel<events::Listenable<events::listeners::listener_of_t<T, typename T::owner_type>>, typename T::owner_type>
	{
		...
		public:
			...
			///@brief Constructs a new observed object with the given object and requirement
			...
			///@brief Constructs a new observed object with the given object, callback and requirement
			...
			*/
			...
			///@brief Returns true if this observed object is observing an object
			...
			///@details Returns nullptr if this observed object is not observing an object
			...
			*/
			...
			///@brief Returns a pointer to a mutable object
			///@details Returns nullptr if this observed object does not observe an object
			[[nodiscard]] inline auto Object() noexcept	
			{
				return managed_object_;
			}

			///@brief Returns a pointer to an immutable object
			///@details Returns nullptr if this observed object does not observe an object
			...
			*/
			...
			///@details If another object is already being observed, that object is released automatically (if possible by the requirements).
			...
			///@brief Releases the object being observed
