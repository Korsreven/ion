	...
	namespace shader_layout
	{
		...
		inline const auto DefaultUniformBindings =
			UniformBindings
			{
				...
				{UniformName::Material_Ambient,				{"material.ambient",				20}},
				{UniformName::Material_Diffuse,				{"material.diffuse",				21}},
				{UniformName::Material_Specular,			{"material.specular",				22}},
				{UniformName::Material_Emissive,			{"material.emissive",				23}},
				{UniformName::Material_Shininess,			{"material.shininess",				24}},
				{UniformName::Material_DiffuseMap,			{"material.diffuse_map",			25}},
				{UniformName::Material_NormalMap,			{"material.normal_map",				26}},
				{UniformName::Material_SpecularMap,			{"material.specular_map",			27}},
				{UniformName::Material_EmissiveMap,			{"material.emissive_map",			28}},
				{UniformName::Material_HasDiffuseMap,		{"material.has_diffuse_map",		29}},
				{UniformName::Material_HasNormalMap,		{"material.has_normal_map",			30}},
				{UniformName::Material_HasSpecularMap,		{"material.has_specular_map",		31}},
				{UniformName::Material_HasEmissiveMap,		{"material.has_emissive_map",		32}},
				{UniformName::Material_LightingEnabled,		{"material.lighting_enabled",		33}},

				{UniformName::Fog_Mode,						{"fog.mode",						34}},
				{UniformName::Fog_Density,					{"fog.density",						35}},
				{UniformName::Fog_Near,						{"fog.near",						36}},
				{UniformName::Fog_Far,						{"fog.far",							37}},
				{UniformName::Fog_Color,					{"fog.color",						38}},

				{UniformName::Light_Type,					{"light[0].type",					39}},
				{UniformName::Light_Position,				{"light[0].position",				40}},
				{UniformName::Light_Direction,				{"light[0].direction",				41}},
				{UniformName::Light_Radius,					{"light[0].radius",					42}},
				{UniformName::Light_Ambient,				{"light[0].ambient",				43}},
				{UniformName::Light_Diffuse,				{"light[0].diffuse",				44}},
				{UniformName::Light_Specular,				{"light[0].specular",				45}},
				{UniformName::Light_Constant,				{"light[0].constant",				46}},
				{UniformName::Light_Linear,					{"light[0].linear",					47}},
				{UniformName::Light_Quadratic,				{"light[0].quadratic",				48}},
				{UniformName::Light_Cutoff,					{"light[0].cutoff",					49}},
				{UniformName::Light_OuterCutoff,			{"light[0].outer_cutoff",			50}},

				{UniformName::EmissiveLight_Position,		{"emissive_light[0].position",		51}},
				{UniformName::EmissiveLight_Radius,			{"emissive_light[0].radius",		52}},
				{UniformName::EmissiveLight_Color,			{"emissive_light[0].color",			53}}
			};
