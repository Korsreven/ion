	...
	namespace shader_layout
	{
		...
		inline const auto DefaultUniformBindings =
			UniformBindings
			{
				...
				{UniformName::Material_HasDiffuseMap,		{"material.has_diffuse_map",		28}},
				{UniformName::Material_HasNormalMap,		{"material.has_normal_map",			29}},
				{UniformName::Material_HasSpecularMap,		{"material.has_specular_map",		30}},		
				{UniformName::Material_LightingEnabled,		{"material.lighting_enabled",		31}},

				{UniformName::Fog_Mode,						{"fog.mode",						32}},
				{UniformName::Fog_Density,					{"fog.density",						33}},
				{UniformName::Fog_Near,						{"fog.near",						34}},
				{UniformName::Fog_Far,						{"fog.far",							35}},
				{UniformName::Fog_Color,					{"fog.color",						36}},

				{UniformName::Light_Type,					{"light[0].type",					37}},
				{UniformName::Light_Position,				{"light[0].position",				38}},
				{UniformName::Light_Direction,				{"light[0].direction",				39}},
				{UniformName::Light_Radius,					{"light[0].radius",					40}},
				{UniformName::Light_Ambient,				{"light[0].ambient",				41}},
				{UniformName::Light_Diffuse,				{"light[0].diffuse",				42}},
				{UniformName::Light_Specular,				{"light[0].specular",				43}},
				{UniformName::Light_Constant,				{"light[0].constant",				44}},
				{UniformName::Light_Linear,					{"light[0].linear",					45}},
				{UniformName::Light_Quadratic,				{"light[0].quadratic",				46}},
				{UniformName::Light_Cutoff,					{"light[0].cutoff",					47}},
				{UniformName::Light_OuterCutoff,			{"light[0].outer_cutoff",			48}},

				{UniformName::EmissiveLight_Position,		{"emissive_light[0].position",		49}},
				{UniformName::EmissiveLight_Radius,			{"emissive_light[0].radius",		50}},
				{UniformName::EmissiveLight_Color,			{"emissive_light[0].color",			51}}
			};
