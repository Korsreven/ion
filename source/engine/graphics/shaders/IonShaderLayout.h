	...
	namespace shader_layout
	{
		...
		inline const auto DefaultUniformBindings =
			UniformBindings
			{
				...
				{UniformName::Node_Position,				{"node.position",					13}},
				{UniformName::Node_Direction,				{"node.direction",					14}},
				{UniformName::Node_Rotation,				{"node.rotation",					15}},
				{UniformName::Node_Scaling,					{"node.scaling",					16}},

				{UniformName::Primitive_Texture,			{"primitive.texture",				17}},
				{UniformName::Primitive_HasTexture,			{"primitive.has_texture",			18}},
				{UniformName::Primitive_HasMaterial,		{"primitive.has_material",			19}},
				{UniformName::Primitive_LightMask,			{"primitive.light_mask",			20}},
				{UniformName::Primitive_EmissiveLightMask,	{"primitive.emissive_light_mask",	21}},

				{UniformName::Material_Ambient,				{"material.ambient",				22}},
				{UniformName::Material_Diffuse,				{"material.diffuse",				23}},
				{UniformName::Material_Specular,			{"material.specular",				24}},
				{UniformName::Material_Emissive,			{"material.emissive",				25}},
				{UniformName::Material_Shininess,			{"material.shininess",				26}},
				{UniformName::Material_DiffuseMap,			{"material.diffuse_map",			27}},
				{UniformName::Material_NormalMap,			{"material.normal_map",				28}},
				{UniformName::Material_SpecularMap,			{"material.specular_map",			29}},
				{UniformName::Material_EmissiveMap,			{"material.emissive_map",			30}},
				{UniformName::Material_HasDiffuseMap,		{"material.has_diffuse_map",		31}},
				{UniformName::Material_HasNormalMap,		{"material.has_normal_map",			32}},
				{UniformName::Material_HasSpecularMap,		{"material.has_specular_map",		33}},
				{UniformName::Material_HasEmissiveMap,		{"material.has_emissive_map",		34}},
				{UniformName::Material_LightingEnabled,		{"material.lighting_enabled",		35}},

				{UniformName::Fog_Mode,						{"fog.mode",						36}},
				{UniformName::Fog_Density,					{"fog.density",						37}},
				{UniformName::Fog_Near,						{"fog.near",						38}},
				{UniformName::Fog_Far,						{"fog.far",							39}},
				{UniformName::Fog_Color,					{"fog.color",						40}},

				{UniformName::Light_Type,					{"light[0].type",					41}},
				{UniformName::Light_Position,				{"light[0].position",				42}},
				{UniformName::Light_Direction,				{"light[0].direction",				43}},
				{UniformName::Light_Radius,					{"light[0].radius",					44}},
				{UniformName::Light_Ambient,				{"light[0].ambient",				45}},
				{UniformName::Light_Diffuse,				{"light[0].diffuse",				46}},
				{UniformName::Light_Specular,				{"light[0].specular",				47}},
				{UniformName::Light_Constant,				{"light[0].constant",				48}},
				{UniformName::Light_Linear,					{"light[0].linear",					49}},
				{UniformName::Light_Quadratic,				{"light[0].quadratic",				50}},
				{UniformName::Light_Cutoff,					{"light[0].cutoff",					51}},
				{UniformName::Light_OuterCutoff,			{"light[0].outer_cutoff",			52}},

				{UniformName::EmissiveLight_Position,		{"emissive_light[0].position",		53}},
				{UniformName::EmissiveLight_Radius,			{"emissive_light[0].radius",		54}},
				{UniformName::EmissiveLight_Color,			{"emissive_light[0].color",			55}}
			};
