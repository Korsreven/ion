	...
	namespace shader_layout
	{
		...
		inline const auto DefaultUniformBindings =
			UniformBindings
			{
				...
				{UniformName::Material_Emissive,			{"material.emissive",				10}},
				{UniformName::Material_Shininess,			{"material.shininess",				11}},
				{UniformName::Material_DiffuseMap,			{"material.diffuse_map",			12}},
				{UniformName::Material_SpecularMap,			{"material.specular_map",			13}},
				{UniformName::Material_NormalMap,			{"material.normal_map",				14}},
				{UniformName::Material_HasDiffuseMap,		{"material.has_diffuse_map",		15}},
				{UniformName::Material_HasSpecularMap,		{"material.has_specular_map",		16}},
				{UniformName::Material_HasNormalMap,		{"material.has_normal_map",			17}},

				{UniformName::Light_Type,					{"light[0].type",					18}},
				{UniformName::Light_Position,				{"light[0].position",				19}},
				{UniformName::Light_Direction,				{"light[0].direction",				20}},
				{UniformName::Light_Ambient,				{"light[0].ambient",				21}},
				{UniformName::Light_Diffuse,				{"light[0].diffuse",				22}},
				{UniformName::Light_Specular,				{"light[0].specular",				23}},
				{UniformName::Light_Constant,				{"light[0].constant",				24}},
				{UniformName::Light_Linear,					{"light[0].linear",					25}},
				{UniformName::Light_Quadratic,				{"light[0].quadratic",				26}},
				{UniformName::Light_Cutoff,					{"light[0].cutoff",					27}},
				{UniformName::Light_OuterCutoff,			{"light[0].outer_cutoff",			28}}
			};
