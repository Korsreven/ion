	...
	namespace shader_layout
	{
		...
		inline const auto DefaultUniformBindings =
			UniformBindings
			{
				...
				{UniformName::Primitive_LightMask,			{"primitive.light_mask",			16}},
				{UniformName::Primitive_EmissiveLightMask,	{"primitive.emissive_light_mask",	17}},
				...
				{UniformName::Material_EmissiveMap,			{"material.emissive_map",			26}},
				{UniformName::Material_HasDiffuseMap,		{"material.has_diffuse_map",		27}},
				{UniformName::Material_HasNormalMap,		{"material.has_normal_map",			28}},
				{UniformName::Material_HasSpecularMap,		{"material.has_specular_map",		29}},
				{UniformName::Material_HasEmissiveMap,		{"material.has_emissive_map",		30}},
