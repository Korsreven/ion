	...
	{	
		...
		if (engine.Initialize())
		{
			...
			[[maybe_unused]] auto text =
				texts.CreateText(
					"pangram",
					"<mark>The <u><i>quick</i></u> <del><font color='saddlebrown'>brown</font></del> fox <b>jumps</b> <sup>over</sup> the <i>lazy</i> dog</mark>",
					verdana_12);

			text->AppendLine("<mark>How <del><font color='olivedrab'>vexingly</font></del> <span style='text-decoration:overline;'>quick</span> <sub>daft</sub> zebras <b>jump</b>!</mark>");
